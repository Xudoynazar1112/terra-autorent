  ...
  return (
    <div className="bg-gray-900 text-white text-start w-full flex flex-col items-start px-40 py-20">
      ...
      <p className="why-zoom">
        <span className="text-xl font-semibold">Elegant Car Fleet:</span> We
      ...
      <p className="why-zoom">
        <span className="text-xl font-semibold">Worry-Free Rental: </span>
      ...
      <p className="why-zoom">
        <span className="text-xl font-semibold">Transparency and Trust: </span>
      ...
      <p className="why-zoom">
        <span className="text-xl font-semibold">Service at Your Level: </span>
      ...
      <p className="why-zoom">
        <span className="text-xl font-semibold">Contact Us: </span>Trust the
